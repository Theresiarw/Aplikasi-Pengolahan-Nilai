                      ...
                      <form class="form-horizontal style-form" action="insert-siswa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <?php
                   include "../conn.php";
                    $qry=mysql_query("SELECT MAX(kode_siswa) AS maxkode FROM siswa") or die (mysql_error());
                    ...
                    ?>
                                  ...
                                  <input name="kode_siswa" type="text" id="kode_siswa" class="form-control" value="<?php echo $kode;?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
