                      ...
                      <form class="form-horizontal style-form" action="insert-guru.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                       <?php
                   include "../conn.php";
                    $qry=mysql_query("SELECT MAX(kode_guru) AS maxkode FROM guru") or die (mysql_error());
                    ...
                    ?>
                                  <input name="kode_guru" type="text" id="kode_guru" class="form-control" value="<?php echo $kode;?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NIP</label>
                              <div class="col-sm-4">
                                  <input name="nip" type="text" id="nip" class="form-control" placeholder="Nomor Induk Pegawai"  />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <textarea name="alamat" cols="50" rows="4" id="alamat" required></textarea>
