...
$result=mysqli_query($koneksi,"SELECT siswa.kode_siswa, siswa.nis, siswa.nama_siswa,
                                        ...
                                        nilai.nilai_uts, nilai.nilai_uas, nilai.rata_rata, nilai.keterangan,
                                       kelas.tahun_ajar, kelas.kelas
                                        ...
                                        siswa.kode_siswa='$kodesaya' AND nilai.semester='$kode'") or die(mysqli_error());
...
$pdf->Image('../foto/logo.png',10,10,-270);
//$pdf->Image('../images/BBRI.png',190,10,-200);
$pdf->SetFont('Arial','B',11);
$pdf->Cell(80);
$pdf->Cell(30,10,'DAFTAR NILAI SISWA',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'SMP NEGERI 5 SENDAWAR',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(40,8,'JL.Satya Jaya RT 1 Pepas Eheng, Kec.Barong Tongkok Kode Pos 75576',0,0,'C');
$pdf->Ln();
$pdf->Line(1,37.1,250,37.1);
$pdf->SetLineWidth(0.5);
$pdf->Line(1,37.2,250,37.2);
...
$pdf->SetX(5);
$pdf->Cell(40,5,'Nama Sekolah : SMPN 5 Sendawar',0,1,'L',1);
$pdf->SetX(40);
...
$pdf->SetX(160);
$pdf->Cell(45,2,'Kelas : '.$kelas,0,0,'R',1);
$pdf->Ln();
...
$pdf->SetY($Y_Fields_Name_position);
$pdf->SetX(5);
$pdf->Cell(40,8,'Alamat              : Jl.Satya Jaya RT.3',0,0,'L',1);
$pdf->SetX(100);
$pdf->Cell(40,8,'',0,0,'L',1);
$pdf->SetX(85);
$pdf->Cell(50,8,'',0,0,'C',1);
...
$pdf->Cell(25,8,'',0,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(42.5,8,'Semester : '.$semester,0,0,'R',1);
...
$pdf->Cell(25,8,'',0,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(48,8,'Tahun Pelajaran : '.$tahun,0,0,'R',1);
$pdf->Ln();
...
$pdf->SetY($Y_Fields_Name_position);
$pdf->SetX(5);
$pdf->Cell(60,8,'NIS / NISN        : '.$nis,0,0,'L',1);
$pdf->SetX(160);
$pdf->Cell(40,8,'',0,0,'L',1);
$pdf->SetX(85);
$pdf->Cell(50,8,'',0,0,'C',1);
...
$pdf->SetY($Y_Table_Position);
$pdf->SetX(165);
$pdf->MultiCell(40,8,$column_rata,1,'C');
...
$pdf->Cell(25,8,'',0,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(40,8,'Wali Kelas, ',0,0,'R',1);
$pdf->Ln();
...
$pdf->Cell(25,8,'',0,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(35,8,'Rohana,S.Pd',0,0,'R',1);

$pdf->Ln();

//$Y_Fields_Name_position = 179;
//$pdf->SetFillColor(255,255,255);
//First create each Field Name
//Bold Font for Field Name
/**$pdf->SetFont('Arial','B',10);
