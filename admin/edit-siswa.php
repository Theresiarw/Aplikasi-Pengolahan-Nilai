      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php
            $query = mysqli_query($koneksi,"SELECT * FROM siswa WHERE kode_siswa='$_GET[kd]'");
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="update-siswa.php" method="post" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="kode_siswa" type="text" id="kode_siswa" class="form-control" value="<?php echo $data['kode_siswa'];?>" readonly="readonly" autofocus="on" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <textarea name="alamat" cols="50" rows="4" id="alamat" required><?php echo $data['alamat'];?></textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                  <input name="password" class="form-control" id="password" type="text" value="<?php echo $data['password'];?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gambar</label>
                              <div class="col-sm-5">
                                  <img src="<?php echo $data['gambar'];?>" height="200" width="150" style="border: 2px solid #666666;" class="img-rounded"/>
