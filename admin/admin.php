      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="ace-icon fa fa-home"></i> Home &raquo; Data Admin</h3>
          	<div class="row mt">
              <div class="col-lg-4">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	...
          	<div class="row mt">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <td><img src="<?php echo $data['gambar']; ?>" class="img-rounded" width="60" style="border: 3px solid black;" /></td>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="input-admin.php" class="btn btn-primary">Tambah Admin <i class="fa fa-arrow-circle-right"></i></a>
