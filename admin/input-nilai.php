                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" onsubmit="return formCheck(this);" action="insert-nilai.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas1" id="nilai_tugas1" placeholder="Standar Kompentensi 1" class="form-control required number" maxlength="3" required="required"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 2</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas2" id="nilai_tugas2" placeholder="Standar Kompentensi 2" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 3</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas3" id="nilai_tugas3" placeholder="Standar Kompentensi 3" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 4</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas4" id="nilai_tugas4" placeholder="Standar Kompentensi 4" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 5</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas5" id="nilai_tugas5" placeholder="Standar Kompentensi 5" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 6</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas6" id="nilai_tugas6" placeholder="Standar Kompentensi 6" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 7</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas7" id="nilai_tugas7" placeholder="Standar Kompentensi 7" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 8</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas8" id="nilai_tugas8" placeholder="Standar Kompentensi 8" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 9</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas9" id="nilai_tugas9" placeholder="Standar Kompentensi 9" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 10</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas10" id="nilai_tugas10" placeholder="Standar Kompentensi 10" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 11</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_tugas11" id="nilai_tugas11" placeholder="Standar Kompentensi 11" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_uts" id="nilai_uts" placeholder="Nilai UTS" class="form-control required number" maxlength="3" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> Nilai UAS</label>
                              <div class="col-sm-4">
                                  <input type="text" name="nilai_uas" id="nilai_uas" placeholder="Nilai UAS" class="form-control required number" maxlength="3" required="required" />
                              </div>
														</div>
	                          <div class="form-group">
