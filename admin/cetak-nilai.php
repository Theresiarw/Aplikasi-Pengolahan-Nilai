      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="profile.php?id=<?php echo $_SESSION['user_id']; ?>"><img src="<?php echo $_SESSION['gambar']; ?>" class="img-circle" width="60" style="border: 3px solid white;"/></a></p>
                  <h5 class="centered">
              <?php
      ...
      <section id="main-content">
        ...
        WHERE nilai.id = $kodeku ORDER BY semester, kode_pelajaran ASC");**/
                ...
                $tampil=mysqli_query($koneksi,"SELECT siswa.kode_siswa, siswa.nis, siswa.nama_siswa,
                                        ...
                                        siswa.kode_siswa='$kodeku'") or die(mysqli_error());
                     ?>
