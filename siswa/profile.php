      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.php?id=<?php echo $_SESSION['user_id']; ?>"><img src="../admin/<?php echo $_SESSION['gambar']; ?>" class="img-rounded" width="100" style="border: 0px solid white;"/></a></p>
              	  <h5 class="centered">
              <?php
              echo $_SESSION['nama'];
               ?></h5>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="ace-icon fa fa-home"></i> Home &raquo; Profile Siswa</h3>
          	...
          	<div class="row mt">
                ...
                Form Biodata Siswa
                    ...
                    <?php
            $query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE kode_siswa='$_GET[id]'");
            ...
            ?>
                      ...
                      <tr>
                      <td width="250">Nis</td>
                      <td width="565" colspan="1"><?php echo $data['nis']; ?></td>
                      </tr>
                       <tr>
                      <td width="250">Nama Siswa</td>
                      <td width="565" colspan="1"><?php echo $data['nama_siswa']; ?></td>
                      </tr>
                      <tr>
                      <td>Kelamin</td>
                      ...
                      <tr>
                      <td>Tanggal Lahir</td>
                      <td colspan="1"><?php echo $data['tanggal_lahir']; ?></td>
                      </tr>
                      <tr>
                      <td>Alamat</td>
                      ...
                      <td colspan="1"><?php echo $data['no_telepon']; ?></td>
                       ...
                       <tr>
                      <td>Tahun Angakatan</td>
                      <td colspan="2"><?php echo $data['tahun_angkatan']; ?></td>
                      </tr>
                      <tr>
                      <td>Status Siswa</td>
                      <td colspan="2"><?php echo $data['status']; ?></td>
                      </tr>
                      <tr>
                      <td>Username</td>
                      ...
                      <tr>
                      <td>Password</td>
                      <td><input class="form-password form-control" value="<?php echo $data['password']; ?>" type="password" readonly="readonly"> </td>
